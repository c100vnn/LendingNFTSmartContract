    ...
    IBaseDoNFT
{
    ...
    function isValidNow(uint256 tokenId)
        public
        view
        override
    ...
    function getNonce(uint256 tokenId) external view override returns (uint64) {
    ...
    function getMaxDuration() public view override returns (uint64) {
        return maxDuration;
    }
    ...
    function getOriginalNftAddress() external view override returns (address) {
        return oNftAddress;
    }

    function getOriginalNftId(uint256 tokenId)
        external
        view
        override
        returns (uint256)
    ...
    function getVNftId(uint256 originalNftId)
        public
        view
        override
        returns (uint256)
